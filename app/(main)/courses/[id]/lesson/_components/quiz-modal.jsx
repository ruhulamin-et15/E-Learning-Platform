import { addQuizAssessment } from "@/app/actions/quizzes";
...
export function QuizModal({ quizSetId, courseId, quizzes, open, setOpen }) {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[95%] block">
          ...
          <DialogFooter className="flex gap-4 justify-between w-full sm:justify-between">
            ...
            <Button
              type="submit"
              className="gap-2 rounded-3xl bg-green-500"
              onClick={submitQuiz}
            >
              Submit Quiz
            </Button>
